...
const MyHomes = () => {
  ...
  const getHomes = async () => {
    try {
      const response = await fetch(
        "https://backend-git-main-saiganeshs-projects-2806edd9.vercel.app/myhomes",
        { credentials: "include" }
      );
  ...
  const handleEdit = async (items, e) => {
    ...
    //  await fetch(`https://backend-git-main-saiganeshs-projects-2806edd9.vercel.app/update`, {method: "POST",headers:{"Content-Type": "application/json" }, body: JSON.stringify({...items}) })
  };
